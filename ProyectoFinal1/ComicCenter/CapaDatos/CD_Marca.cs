        ...
        public List<Marca> ListarMarcaporTipoArticulo(int idtipoarticulo)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    sb.AppendLine("select distinct m.IdMarca, m.Nombre from Producto p");
                    ...
                    sb.AppendLine("where tp.IdTipoArticulo = iif(@idtipoarticulo = 0, tp.IdTipoArticulo, @idtipoarticulo)");

                    SqlCommand cmd = new SqlCommand(sb.ToString(), oconexion);
                    cmd.Parameters.AddWithValue("@idtipoarticulo", idtipoarticulo);
